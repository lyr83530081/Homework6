...
from util.utils import (decodebox, efficientdet_correct_boxes,
...
class EfficientDet(object):
    _defaults = {
        "model_path"    : 'logs/Epoch1-Total_Loss0.5338-Val_Loss0.4328.pth',
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(top_label):
            ...
            info_temp = [predicted_class, score, top, left, bottom, right]
