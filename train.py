...
from util.dataloader import efficientdet_dataset_collate,EfficientdetDataset
...
if __name__ == "__main__":
    ...
    #   权值文件请看README，百度网盘下载
    #------------------------------------------------------#
    model_path = "logs/Epoch947-Total_Loss0.6271-Val_Loss0.4328.pth"
    ...
    if True:
        ...
        lr_scheduler    = optim.lr_scheduler.ReduceLROnPlateau(optimizer, factor=0.95, patience=3, verbose=True)
